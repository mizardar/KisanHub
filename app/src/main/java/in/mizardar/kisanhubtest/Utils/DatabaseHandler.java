...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public HashMap<String, Integer> getRegionList() {
        SQLiteDatabase dataBase = this.getWritableDatabase();
        //String sql = "select * from " + CATEGORY_TABLE;// + " ORDER BY " + Student_Percentage + " DESC";
        HashMap<String, Integer> regionList = new HashMap<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                int regionID = cursor.getInt(cursor.getColumnIndex(KEY_REGION_ID));
                String regionName = cursor.getString(cursor.getColumnIndex(KEY_REGION_NAME));
                regionList.put(regionName,regionID);
    ...
    public HashMap<String, Integer> getCategoryList() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                int catID = cursor.getInt(cursor.getColumnIndex(KEY_CATEGORY_ID));
                String catName = cursor.getString(cursor.getColumnIndex(KEY_CATEGORY_NAME));
                catList.put(catName,catID);
